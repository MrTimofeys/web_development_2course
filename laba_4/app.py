...
DATABASE = BASE_DIR / 'instance' / 'laba_4.sqlite'
...
def edit_user(user_id):
    ...
    return render_template('user_form.html', title='Редактирование пользователя', data=data, errors=errors, roles=roles(), is_create=False)
